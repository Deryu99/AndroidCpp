...
extern "C" [[maybe_unused]] JNIEXPORT void JNICALL Java_com_testingApp_androidCpp_MainActivity_renderPlasma(JNIEnv * env, jobject  obj, jobject bitmap,  jlong  time_ms)
{
